...
import { CandidatePlans, GatiDashboard, Maintenance, Notifications, Profile, Reports, RiskDashboard, Settings, SimulationResults, Administration } from '../pages/operations/Operations.jsx';
...
export function AppRouter() {
  ...
  return <AnimatePresence mode="wait"><Routes location={location} key={location.pathname}>
    ...
    <Route element={<Protected><AppShell /></Protected>}>
      ...
      <Route path="/plans" element={animated(CandidatePlans)} /><Route path="/simulation" element={animated(SimulationResults)} />
